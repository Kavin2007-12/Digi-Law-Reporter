...
export default function TopicSearchForm({ topic, setTopic, onSearch }) {
  return (
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            placeholder="e.g. Fundamental Rights, Arbitration, Insolvency..."
          ...
          />
          <Library size={20} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" />
        </div>
      </div>
